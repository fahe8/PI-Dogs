...
<div className='container-Pagination'>
      <button className='btn' onClick={prev} disabled={page === 1 || page < 1}><span className='fingerprint-left'></span></button>
      ...
      <p>de {pageMax}</p>
      <button className='btn' onClick={next} disabled={page === pageMax || page > pageMax}><span className='fingerprint-right'></span></button>
    </div>
  )
}
